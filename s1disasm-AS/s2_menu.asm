...
Offset_0x026B4E:
                ...
                moveq   #$00, D0
                move.w  #$0009, D1  ; Quantidade de textos a ser carregada e posi��o do Sound Test
Menu_Loop_Load_Text:
                move.w  (A5)+, D3
                lea     (A3, D3.w), A2
                moveq   #$00, D2
...
;-------------------------------------------------------------------------------
                ...
                clr.w   ($FFFFF7F0).w
;------------------------------------------------------------------------------- 
                move.w  #$0000, ($FFFFF7B8).w  ; Inicializa os quadros das anima��es do menu
                move.w  #$0000, ($FFFFF7BA).w  ; Inicializa o contador das anima��es do menu
                jsr     (Dynamic_Menu).l           ; Chama a rotina de anima��o
;-------------------------------------------------------------------------------
...
Offset_0x026DFC:
                ...
                moveq   #$15, D0     ; �ltimo item ap�s apertar para cima
Offset_0x026E1C:
                btst    #$01, D1
...
Offset_0x026F78:
                rts
Offset_0x026F7A:
                move.l  #$49C60003, ($00C00004).l ; Posi��o dos n�meros do Sound Test
                move.w  ($FFFFFF84).w, D0
                move.b  D0, D2
                lsr.b   #$04, D0
