...
SSRGScreen:
		moveq	#$FFFFFFEF,d0				; set music ID to "stop music"
...
;	 	bsr	DelayProgram				; hult til V-Blank begins
...
SSRGScreen_Finish:
  ...
  ;      include "CustomSplash1/CustomSplash1.asm"
		rts						; return
...
;		move.w	#$90,$2A(a0)				; set timer
		move.w	#$00C0,$2A(a0)				; set timer
		move.w	#$400,$10(a0)				; set X speed
...
OSN_MoveIn:
		...
		moveq	#$FFFFFF9E,d0				; set to play spinning SFX
		bsr.w	PlaySound_Special			; play SFX
		addq.b	#$02,$24(a0)				; increase routine counter
...
OS_PlaySound:
		addq.b	#$02,$24(a0)				; increase routine counter
		moveq	#$FFFFFF9C,d0				; set to play spin release SFX
		bsr.w	PlaySound_Special			; play SFX
...
OS_SpinIn:
		...
		addq.b	#$02,$24(a0)				; increase routine counter
		moveq	#$FFFFFF9D,d0				; set to play spiked chandelier SFX
		bsr.w	PlaySound_Special		; play SFX
...
OS_FinishSpin:
		...
		lea	($FFFFF2).w,a1			; load palette buffer address
...
Pal_SSRG:	dc.w	$0000,$0400,$0800,$0C00,$0E00,$0EEE,$0AAA,$0888
		...
		even
; ---------------------------------------------------------------------------
ArtMain_SSRG:	binclude	"SSRG/ArtMain.nem"
		even
ArtSquare_SSRG:	binclude	"SSRG/ArtSquare.nem"
		even
ArtSonic_SSRG:	binclude	"SSRG/ArtSonic.nem"
		even
ArtLink_SSRG:	binclude	"SSRG/ArtLink.nem"
		even
; ---------------------------------------------------------------------------
MapMain_SSRG:	binclude	"SSRG/MapMain.kos"
		even
MapSquare_SSRG:	binclude	"SSRG/MapSquare.kos"
		even
MapLink_SSRG:	binclude	"SSRG/MapLink.kos"
		even
