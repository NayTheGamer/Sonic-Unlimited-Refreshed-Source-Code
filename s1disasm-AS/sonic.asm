...
ptr_GM_SSRGScreen:		bra.w	SSRGScreen	; CreditsSSRG Screen ($20)

ptr_GM_NaySplash:		bra.w	GM_RetroSplash	; NaySplash Screen ($30)
...
GM_RetroSplash:
		...
		bsr.w	ClearScreen
		locVRAM	0
		lea	(CustomSplash1_Tiles).l,a0 ; load Sega	logo patterns
		bsr.w	NemDec
		lea	($FF0000).l,a1
		lea	(CustomSplash1_Mappings).l,a0 ; load Sega	logo mappings
		move.w	#0,d0
;		bsr.w	EniDec
...
Sega2_WaitEnd:
		...
		bsr.w	WaitForVBla
		tst.w	(v_demolength).w
		beq.s	Sega_GotoTitle2
		andi.b	#btnStart,(v_jpadpress1).w ; is Start button pressed?
		beq.s	Sega2_WaitEnd	; if not, branch
...
;		bsr.w	PaletteWhiteOut
		...
		move.w	#0,d0
		bsr.w	EniDec
;		move.b	#sfx_SSGoalLow,d0
;		bsr.w	PlaySound_Special	; play SSgoal SFX			
;		bsr.w	PaletteWhiteOut
;		move.b	#5,(v_vbla_routine).w
;		bsr.w	WaitForVBla											
;		bsr.w	PaletteWhiteIn													
		...
		move.w	#$268,(v_demolength).w ; run title screen for $178 frames
...
Map_Stair:	include	"_maps/Staircase.asm"
		...
		include	"_incObj/5E GHZ Pylon.asm"		
Map_Pylon:	include	"_maps/Pylon.asm"
Map_PylonGHZ:	include	"_maps/GHZ Pylon.asm"
...
CustomSplash1_Tiles: binclude "CustomSplash1/Tiles.bin"
       even
CustomSplash1_Mappings: binclude "CustomSplash1/mappings SonMaped.bin"
       even			
...
Eni_SonicTeamMap: 	;include	"CustomTeamPresents/SonicTeamMap.asm" ; Japanese credits (mappings)
		even
...
Nem_PylonSmaller:	binclude	"artnem/SLZ PylonSmaller.bin"
		even
...
Nem_CreditText:	binclude	"artnem/Ending - Credits.bin"
		even
Nem_SonicTeam:	binclude	"CustomTeamPresents/SonicTeam.bin"
		even		
